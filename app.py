        ...
        try:
            ...
            with st.spinner(spinner_text):
                ...
                try:
                    ...
                    st.warning("⚠️ The AI analysis encountered an issue, but we're showing you a provisional score instead. The actual score may vary once the API works correctly.")
